...
{
	ssize_t		(*seg_read) (int fd, void *buf, size_t count, pgoff_t offset,
							 TimeLineID tli, XLogSegNo segno, int segSize);

	ssize_t		(*seg_write) (int fd, const void *buf, size_t count, pgoff_t offset,
							  TimeLineID tli, XLogSegNo segno, int segSize);
} XLogSmgr;

static inline ssize_t
default_seg_write(int fd, const void *buf, size_t count, pgoff_t offset,
				  TimeLineID tli, XLogSegNo segno, int segSize)
{
...
static inline ssize_t
default_seg_read(int fd, void *buf, size_t count, pgoff_t offset,
				 TimeLineID tli, XLogSegNo segno, int segSize)
{
